          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative">
              ...
              {isResourcesOpen && (
                <div className="absolute z-50 mt-2 w-48 bg-white rounded-md shadow-lg py-1">
                  ...
                  <Link to="/faqs" className="block px-4 py-2 text-gray-700 hover:bg-primary-50">FAQs</Link>
                </div>
              )}
            </div>
            ...
            {currentUser ? (
              ...
              <>
                ...
                <Link to="/register" className="btn bg-primary-600 text-white hover:bg-primary-700 px-4 py-2">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {isResourcesOpen && (
                <div className="pl-4 flex flex-col space-y-2">
                  ...
                  <Link to="/faqs" className="text-gray-700 hover:text-primary-600">FAQs</Link>
                </div>
              )}
